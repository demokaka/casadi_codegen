 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Thu Sep 11 17:42:65 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                my_mpc
...
/* Input Port  1 */
#define IN_PORT_1_NAME                 xref
#define INPUT_1_DIMS_ND                {12,1}
#define INPUT_1_NUM_ELEMS              12
...
#define SOURCEFILES                    "__SFB__SRC_PATH C:\Users\khanh\dev\python\projects\casadi_codegen\basics\sfunction_builder__SFB__LIB_PATH C:\Users\khanh\dev\matlab\casadi-3.7.1-windows64-matlab2018b__SFB__INC_PATH C:\Users\khanh\dev\python\projects\casadi_codegen\basics\sfunction_builder__SFB__INC_PATH C:\Users\khanh\dev\matlab\casadi-3.7.1-windows64-matlab2018b\include__SFB__C:\Users\khanh\dev\python\projects\casadi_codegen\basics\sfunction_builder\my_solver.c__SFB__C:\Users\khanh\dev\matlab\casadi-3.7.1-windows64-matlab2018b\ipopt.lib__SFB__C:\Users\khanh\dev\matlab\casadi-3.7.1-windows64-matlab2018b\lapack.lib"
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port x0 of S-Function my_mpc");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port xref of S-Function my_mpc");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port u_opt of S-Function my_mpc");
      return;
    }
...
{
  const real_T *x0 = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *xref = (real_T *) ssGetInputPortRealSignal(S, 1);
  real_T *u_opt = (real_T *) ssGetOutputPortRealSignal(S, 0);
  my_mpc_Outputs_wrapper(x0, xref, u_opt);
}
