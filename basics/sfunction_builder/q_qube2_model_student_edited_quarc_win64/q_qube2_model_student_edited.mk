###########################################################################
## Makefile generated for component 'q_qube2_model_student_edited'. 
## 
## Makefile     : q_qube2_model_student_edited.mk
## Generated on : Thu Sep 11 16:20:06 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\q_qube2_model_student_edited.rt-win64
...
PRODUCT_NAME              = q_qube2_model_student_edited
MAKEFILE                  = q_qube2_model_student_edited.mk
...
COMPILER_COMMAND_FILE     = q_qube2_model_student_edited_comp.rsp
CMD_FILE                  = q_qube2_model_student_edited.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\q_qube2_model_student_edited.rt-win64
...
DEFINES_STANDARD = -DMODEL=q_qube2_model_student_edited -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\q_qube2_model_student_edited_quarc_win64\q_qube2_model_student_edited.c $(START_DIR)\q_qube2_model_student_edited_quarc_win64\q_qube2_model_student_edited_data.c $(START_DIR)\q_qube2_model_student_edited_quarc_win64\q_qube2_model_student_edited_main.c $(START_DIR)\q_qube2_model_student_edited_quarc_win64\rtGetInf.c $(START_DIR)\q_qube2_model_student_edited_quarc_win64\rtGetNaN.c $(START_DIR)\q_qube2_model_student_edited_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = q_qube2_model_student_edited.obj q_qube2_model_student_edited_data.obj q_qube2_model_student_edited_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\q_qube2_model_student_edited_quarc_win64}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\q_qube2_model_student_edited_quarc_win64}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
q_qube2_model_student_edited.obj : "$(START_DIR)\q_qube2_model_student_edited_quarc_win64\q_qube2_model_student_edited.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_model_student_edited_quarc_win64\q_qube2_model_student_edited.c"


q_qube2_model_student_edited_data.obj : "$(START_DIR)\q_qube2_model_student_edited_quarc_win64\q_qube2_model_student_edited_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_model_student_edited_quarc_win64\q_qube2_model_student_edited_data.c"


q_qube2_model_student_edited_main.obj : "$(START_DIR)\q_qube2_model_student_edited_quarc_win64\q_qube2_model_student_edited_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_model_student_edited_quarc_win64\q_qube2_model_student_edited_main.c"


rtGetInf.obj : "$(START_DIR)\q_qube2_model_student_edited_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_model_student_edited_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\q_qube2_model_student_edited_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_model_student_edited_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\q_qube2_model_student_edited_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_model_student_edited_quarc_win64\rt_nonfinite.c"
