...
#define test_model_rtModel             RT_MODEL_test_model_T
...
#define rtB                            test_model_B
#define BlockIO                        B_test_model_T
#define rtP                            test_model_P
#define Parameters                     P_test_model_T
#define rtDWork                        test_model_DW
#define D_Work                         DW_test_model_T

/* Parameters (default storage) */
struct P_test_model_T_ {
...
extern P_test_model_T test_model_P;

/* Block signals (default storage) */
extern B_test_model_T test_model_B;
...
extern void test_model_output(void);
extern void test_model_update(void);
extern void test_model_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern test_model_rtModel *test_model(void);
 ...
 *
 * '<Root>' : 'test_model'
 * '<S1>'   : 'test_model/MATLAB Function5'
 * '<S2>'   : 'test_model/Powered by QUARC'
 * '<S3>'   : 'test_model/Quanser'
 */
#endif                                 /* test_model_h_ */
