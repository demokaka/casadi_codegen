 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Thu Sep 11 19:46:30 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                approach_01
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port x0 of S-Function approach_01");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port xref of S-Function approach_01");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port u_opt of S-Function approach_01");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  approach_01_Outputs_wrapper(x0, xref, u_opt);
}
