...
typedef RT_MODEL_model_qube_test_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * model_qube_test(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(model_qube_test_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: model_qube_test -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
