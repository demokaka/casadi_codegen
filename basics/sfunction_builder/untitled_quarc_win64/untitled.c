 ...
 * C source code generated on : Thu Sep 11 16:41:13 2025
 *
...
RT_MODEL_untitled_T *untitled(void)
{
  ...
  /* External mode info */
  untitled_M->Sizes.checksums[0] = (3211044101U);
  untitled_M->Sizes.checksums[1] = (3902791789U);
  untitled_M->Sizes.checksums[2] = (1187022272U);
  untitled_M->Sizes.checksums[3] = (2165046616U);
  ...
  untitled_M->Sizes.numBlocks = (1);   /* Number of blocks */
  untitled_M->Sizes.numBlockPrms = (76);/* Sum of parameter "widths" */
  return untitled_M;
}
