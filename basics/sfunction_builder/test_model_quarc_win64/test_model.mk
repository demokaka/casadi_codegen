###########################################################################
## Makefile generated for component 'test_model'. 
## 
## Makefile     : test_model.mk
## Generated on : Thu Sep 11 18:36:15 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\test_model.rt-win64
...
COMPILER_COMMAND_FILE     = test_model_comp.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\test_model.rt-win64
...
DEFINES_STANDARD = -DMODEL=test_model -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\test_model_quarc_win64\rtGetInf.c $(START_DIR)\test_model_quarc_win64\rtGetNaN.c $(START_DIR)\test_model_quarc_win64\rt_nonfinite.c $(START_DIR)\test_model_quarc_win64\test_model.c $(START_DIR)\test_model_quarc_win64\test_model_data.c $(START_DIR)\test_model_quarc_win64\test_model_main.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj test_model.obj test_model_data.obj test_model_main.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\test_model_quarc_win64}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\test_model_quarc_win64}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : "$(START_DIR)\test_model_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\test_model_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\test_model_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\test_model_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\test_model_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\test_model_quarc_win64\rt_nonfinite.c"


test_model.obj : "$(START_DIR)\test_model_quarc_win64\test_model.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\test_model_quarc_win64\test_model.c"


test_model_data.obj : "$(START_DIR)\test_model_quarc_win64\test_model_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\test_model_quarc_win64\test_model_data.c"


test_model_main.obj : "$(START_DIR)\test_model_quarc_win64\test_model_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\test_model_quarc_win64\test_model_main.c"
