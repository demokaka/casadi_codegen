...
PRODUCT_NAME              = approach_01_casadi_sqpmethod
MAKEFILE                  = approach_01_casadi_sqpmethod.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2025a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2025a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\khanh\dev\python\projects\casadi_codegen\approaches\01
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = approach_01_casadi_sqpmethod_comp.rsp
CMD_FILE                  = approach_01_casadi_sqpmethod.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\approach_01_casadi_sqpmethod.rt-win64
...
DEFINES_STANDARD = -DMODEL=approach_01_casadi_sqpmethod -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_matrx.c $(MATLAB_ROOT)\rtw\c\src\rt_printf.c $(START_DIR)\approach_01_casadi_sqpmethod_quarc_win64\approach_01_casadi_sqpmethod.c $(START_DIR)\approach_01_casadi_sqpmethod_quarc_win64\approach_01_casadi_sqpmethod_data.c $(START_DIR)\approach_01_casadi_sqpmethod_quarc_win64\approach_01_casadi_sqpmethod_main.c $(START_DIR)\approach_01_casadi_sqpmethod_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c $(START_DIR)\solver_01_wrapper.c $(START_DIR)\solver_01.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rt_matrx.obj rt_printf.obj approach_01_casadi_sqpmethod.obj approach_01_casadi_sqpmethod_data.obj approach_01_casadi_sqpmethod_main.obj rt_nonfinite.obj rt_sim.obj solver_01_wrapper.obj solver_01.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\approach_01_casadi_sqpmethod_quarc_win64}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\approach_01_casadi_sqpmethod_quarc_win64}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
approach_01_casadi_sqpmethod.obj : "$(START_DIR)\approach_01_casadi_sqpmethod_quarc_win64\approach_01_casadi_sqpmethod.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\approach_01_casadi_sqpmethod_quarc_win64\approach_01_casadi_sqpmethod.c"


approach_01_casadi_sqpmethod_data.obj : "$(START_DIR)\approach_01_casadi_sqpmethod_quarc_win64\approach_01_casadi_sqpmethod_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\approach_01_casadi_sqpmethod_quarc_win64\approach_01_casadi_sqpmethod_data.c"


approach_01_casadi_sqpmethod_main.obj : "$(START_DIR)\approach_01_casadi_sqpmethod_quarc_win64\approach_01_casadi_sqpmethod_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\approach_01_casadi_sqpmethod_quarc_win64\approach_01_casadi_sqpmethod_main.c"


rt_nonfinite.obj : "$(START_DIR)\approach_01_casadi_sqpmethod_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\approach_01_casadi_sqpmethod_quarc_win64\rt_nonfinite.c"
...
solver_01_wrapper.obj : "$(START_DIR)\solver_01_wrapper.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\solver_01_wrapper.c"


solver_01.obj : "$(START_DIR)\solver_01.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\solver_01.c"
