###########################################################################
## Makefile generated for component 'test_normal_sim'. 
## 
## Makefile     : test_normal_sim.mk
## Generated on : Fri Sep 12 15:50:14 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\test_normal_sim.rt-win64
...
COMPILER_COMMAND_FILE     = test_normal_sim_comp.rsp
CMD_FILE                  = test_normal_sim.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\test_normal_sim.rt-win64
...
DEFINES_STANDARD = -DMODEL=test_normal_sim -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_matrx.c $(MATLAB_ROOT)\rtw\c\src\rt_printf.c $(START_DIR)\test_normal_sim_quarc_win64\rt_nonfinite.c $(START_DIR)\test_normal_sim_quarc_win64\test_normal_sim.c $(START_DIR)\test_normal_sim_quarc_win64\test_normal_sim_data.c $(START_DIR)\test_normal_sim_quarc_win64\test_normal_sim_main.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c $(START_DIR)\solver_01_wrapper.c $(START_DIR)\solver_01.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rt_matrx.obj rt_printf.obj rt_nonfinite.obj test_normal_sim.obj test_normal_sim_data.obj test_normal_sim_main.obj rt_sim.obj solver_01_wrapper.obj solver_01.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\test_normal_sim_quarc_win64}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\test_normal_sim_quarc_win64}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rt_nonfinite.obj : "$(START_DIR)\test_normal_sim_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\test_normal_sim_quarc_win64\rt_nonfinite.c"


test_normal_sim.obj : "$(START_DIR)\test_normal_sim_quarc_win64\test_normal_sim.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\test_normal_sim_quarc_win64\test_normal_sim.c"


test_normal_sim_data.obj : "$(START_DIR)\test_normal_sim_quarc_win64\test_normal_sim_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\test_normal_sim_quarc_win64\test_normal_sim_data.c"


test_normal_sim_main.obj : "$(START_DIR)\test_normal_sim_quarc_win64\test_normal_sim_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\test_normal_sim_quarc_win64\test_normal_sim_main.c"
