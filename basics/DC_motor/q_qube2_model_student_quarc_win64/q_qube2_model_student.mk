###########################################################################
## Makefile generated for component 'q_qube2_model_student'. 
## 
## Makefile     : q_qube2_model_student.mk
## Generated on : Wed Sep 10 15:57:33 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\q_qube2_model_student.rt-win64
...
PRODUCT_NAME              = q_qube2_model_student
MAKEFILE                  = q_qube2_model_student.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2025a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2025a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\khanh\dev\python\projects\casadi_codegen\basics\DC_motor
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = q_qube2_model_student_comp.rsp
CMD_FILE                  = q_qube2_model_student.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\q_qube2_model_student.rt-win64
...
DEFINES_STANDARD = -DMODEL=q_qube2_model_student -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\q_qube2_model_student_quarc_win64\q_qube2_model_student.c $(START_DIR)\q_qube2_model_student_quarc_win64\q_qube2_model_student_data.c $(START_DIR)\q_qube2_model_student_quarc_win64\q_qube2_model_student_main.c $(START_DIR)\q_qube2_model_student_quarc_win64\rtGetInf.c $(START_DIR)\q_qube2_model_student_quarc_win64\rtGetNaN.c $(START_DIR)\q_qube2_model_student_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = q_qube2_model_student.obj q_qube2_model_student_data.obj q_qube2_model_student_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\q_qube2_model_student_quarc_win64}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\q_qube2_model_student_quarc_win64}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
q_qube2_model_student.obj : "$(START_DIR)\q_qube2_model_student_quarc_win64\q_qube2_model_student.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_model_student_quarc_win64\q_qube2_model_student.c"


q_qube2_model_student_data.obj : "$(START_DIR)\q_qube2_model_student_quarc_win64\q_qube2_model_student_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_model_student_quarc_win64\q_qube2_model_student_data.c"


q_qube2_model_student_main.obj : "$(START_DIR)\q_qube2_model_student_quarc_win64\q_qube2_model_student_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_model_student_quarc_win64\q_qube2_model_student_main.c"


rtGetInf.obj : "$(START_DIR)\q_qube2_model_student_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_model_student_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\q_qube2_model_student_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_model_student_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\q_qube2_model_student_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\q_qube2_model_student_quarc_win64\rt_nonfinite.c"
