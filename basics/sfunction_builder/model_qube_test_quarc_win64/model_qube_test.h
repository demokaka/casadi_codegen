...
#ifndef model_qube_test_h_
#define model_qube_test_h_
#ifndef model_qube_test_COMMON_INCLUDES_
#define model_qube_test_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* model_qube_test_COMMON_INCLUDES_ */
...
#define model_qube_test_rtModel        RT_MODEL_model_qube_test_T

/* Block signals (default storage) */
typedef struct {
  real_T thetarad;                     /* '<Root>/counts to rad' */
  real_T omegaradsec;                  /* '<Root>/Derivative' */
  real_T TmpSignalConversionAtSFunctionI[2];
  real_T DelayLine10[6];               /* '<Root>/Delay Line10' */
  real_T xref[12];                     /* '<Root>/Reshape5' */
  real_T uV;                           /* '<Root>/S-Function' */
  real_T uV_k;                         /* '<Root>/Saturation1' */
  real_T ZeroOrderHold5[2];            /* '<Root>/Zero-Order Hold5' */
  real_T ref[2];                       /* '<Root>/MATLAB Function5' */
} B_model_qube_test_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T DelayLine10_Buff[6];          /* '<Root>/Delay Line10' */
  real_T DelayLine11_Buff[6];          /* '<Root>/Delay Line11' */
  ...
  struct {
    void *LoggedData;
  } Scope60_PWORK;                     /* '<Root>/Scope60' */

  struct {
    void *LoggedData;
  } Scope61_PWORK;                     /* '<Root>/Scope61' */

  struct {
    void *LoggedData;
  } Scope62_PWORK;                     /* '<Root>/Scope62' */

  int32_T DelayLine10_BUFF_OFFSET;     /* '<Root>/Delay Line10' */
  int32_T DelayLine11_BUFF_OFFSET;     /* '<Root>/Delay Line11' */
  ...
  int32_T sfEvent;                     /* '<Root>/MATLAB Function5' */
  boolean_T doneDoubleBufferReInit;    /* '<Root>/MATLAB Function5' */
} DW_model_qube_test_T;

/* Backward compatible GRT Identifiers */
#define rtB                            model_qube_test_B
#define BlockIO                        B_model_qube_test_T
#define rtP                            model_qube_test_P
#define Parameters                     P_model_qube_test_T
#define rtDWork                        model_qube_test_DW
#define D_Work                         DW_model_qube_test_T

/* Parameters (default storage) */
struct P_model_qube_test_T_ {
...
struct tag_RTM_model_qube_test_T {
  const char_T *path;
...
extern P_model_qube_test_T model_qube_test_P;

/* Block signals (default storage) */
extern B_model_qube_test_T model_qube_test_B;

/* Block states (default storage) */
extern DW_model_qube_test_T model_qube_test_DW;

/* Model entry point functions */
extern void model_qube_test_initialize(void);
extern void model_qube_test_output(void);
extern void model_qube_test_update(void);
extern void model_qube_test_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern model_qube_test_rtModel *model_qube_test(void);
...
extern RT_MODEL_model_qube_test_T *const model_qube_test_M;
 ...
 *
 * '<Root>' : 'model_qube_test'
 * '<S1>'   : 'model_qube_test/MATLAB Function5'
 * '<S2>'   : 'model_qube_test/Powered by QUARC'
 * '<S3>'   : 'model_qube_test/Quanser'
 */
#endif                                 /* model_qube_test_h_ */
